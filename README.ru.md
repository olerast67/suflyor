...
**Открывает почти всё**
- TXT (UTF-8, UTF-16, Windows-1251, KOI8-R), Markdown и заметки Obsidian, DOCX, ODT, RTF, HTML и PDF (PDF — на Android 15 или на Android 12–14 со свежими системными обновлениями Google Play).
...
```mermaid
flowchart LR
    Mic["Микрофон"] --> ASR["sherpa-onnx<br/>потоковое распознавание<br/>(на телефоне)"]
