...
Отправляй на этот адрес **только USDT в сети TRON (TRC20)**. Монеты из другой сети (Ethereum, BNB Chain…) пропадут безвозвратно.

| Coin | Network | Address |
|---|---|---|
| USDT | **TRON (TRC20)** | `TLS1C2LbbfAtzBQMyU9gppCS8qEXsYeyzQ` |
...
Донаты — добровольные подарки. Они не покупают функции или поддержку, приложение для всех одинаковое.
